...
import com.awesomenessstudios.goodenoughstores.services.image.ImageService;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> saveImages(@RequestParam List<MultipartFile> files, @RequestParam Long productId) {
        try {
            ...
            return ResponseEntity.status(INTERNAL_SERVER_ERROR).body(new ApiResponse("Image not saved successfully", e.getMessage()));
        }
    }
